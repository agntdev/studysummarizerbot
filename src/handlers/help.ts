...
const HELP =
  "Send a PDF, image, DOCX, or .txt study file and I'll summarize it in 3–5 sentences.\n\n" +
  "Use the buttons under a summary to rephrase it, expand it, or make it shorter.";
